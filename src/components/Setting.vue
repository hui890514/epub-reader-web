...
import { changeThemeVariable, themeList } from '@/helpers/theme'
import { currentFontsize, currentThemeIndex, setFontsize, setTheme } from '@/helpers/reader'
...
<template>
  <div pl-1>
    <div id="theme" f-r-n items-center mb-3 h-10>
      <div c-t w-20>
        Theme:
      </div>
    ...
    <div id="fontsize" f-r-n items-center mb-3 h-10>
      <div c-t w-20>
        Fontsize:
      </div>
